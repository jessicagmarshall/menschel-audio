    ...
    setTimeout(async () => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          fetch(document.URL.substr(0, document.URL.length - 5) + '3003/audioDuration?id=' + nextRow)
            .then(res => {
              res.json()
                .then(res => {
                  setTimeout(() => {
                    ...
                    this.setState({
                      ...
                      audioUrl: document.URL.substr(0, document.URL.length - 5) + '3003/audio?id=' + nextRow
                    })
